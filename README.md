...
# 创建一个虚拟环境venv，可以其他名字，此处venv可以gitignore
python3 -m venv venv
# 激活虚拟环境
...
python3 akshare-stock/scripts/analyze_investment.py 600519

# 📈 获取贵州茅台的实时行情

python3 akshare-stock/scripts/get_realtime_quote.py 600519

# 🕯️ 获取最近 60 天的历史 K 线
python3 akshare-stock/scripts/get_history_kline.py 600519 --days 60

# 📑 生成markdown格式的研报
python3 akshare-stock/scripts/stock_analyzer.py 600519 -o report.md
