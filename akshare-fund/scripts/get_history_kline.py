...
用法:
    python get_history_kline.py 000001
    python get_history_kline.py 000001 --days 30
    python get_history_kline.py 000001 --start 20240101 --end 20241231
"""
import argparse
import sys
...
def main():
    parser = argparse.ArgumentParser(description='获取历史行情数据')
